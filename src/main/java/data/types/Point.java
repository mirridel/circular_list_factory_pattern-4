...
/************************************************************************************************************
 *
 * len() - получить расстояние от начала координат
 *
 **********************************************************************************************************************/
...
public class Point implements UserType, Serializable, Cloneable, Comparable<Point> {
    ...
    public Point parseValue(String ss) {
        ...
        if (ss.length() > 0){
            if (ss.charAt(0) == '[' && ss.charAt(size-1) == ']'){
                ...
                Point p = new Point(Float.parseFloat(x), Float.parseFloat(y));
                return p;
            }
        }
        return null;
    ...
    public Comparator <Object> getTypeComparator() {
        //System.out.println("Join getTypeComparator");
        return ((o1, o2) -> ((Point)o1).compareTo((Point) o2));
    }

    @Override
    public int compareTo(Point another) {
        //System.out.println("Join compareTo");
